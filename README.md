...
[![Version](https://img.shields.io/badge/version-1.36.0-blue.svg)](#install)
...
```bash
sf package install --package 04tal000006Ug9dAAC --wait 10 --target-org <your-org>
```

[Install in Production](https://login.salesforce.com/packaging/installPackage.apexp?p0=04tal000006Ug9dAAC) | [Install in Sandbox](https://test.salesforce.com/packaging/installPackage.apexp?p0=04tal000006Ug9dAAC)
...
|---------|---------|------------|
| v1.36.0 | **Latest (Released)** | `04tal000006Ug9dAAC` |
