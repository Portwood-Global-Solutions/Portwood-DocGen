...
[![Version](https://img.shields.io/badge/version-2.7.0.3_Beacon-blue.svg)](#install)
...
```bash
sf package install --package 04tdL000000S2mrQAC --wait 10 --installation-key-bypass
```

[Install in Production](https://login.salesforce.com/packaging/installPackage.apexp?p0=04tdL000000S2mrQAC) | [Install in Sandbox](https://test.salesforce.com/packaging/installPackage.apexp?p0=04tdL000000S2mrQAC)
