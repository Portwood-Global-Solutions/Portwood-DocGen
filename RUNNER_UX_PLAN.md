...
- `getTemplatesForObject_sortOrder` — Sort_Order__c ASC NULLS LAST honored before Is_Default__c
...
- `processAndReturnDocument_outputOverride_lockedTemplate_throws` — Lock_Output_Format__c=true + override given → DocGenException
